...
import prieto.fernando.domain.usecase.GetLaunchInfo
...
class FirstViewModelTest {
    ...
    @Mock
    lateinit var getLaunches: GetLaunchInfo
    ...
    @Mock
    lateinit var launchesMapper: LaunchInfoDomainToUiModelMapper

    @Before
    fun setUp() {
        Dispatchers.setMain(Dispatchers.Unconfined)
        cut = FirstViewModelImpl(getCompanyInfo, getLaunches, companyInfoMapper, launchesMapper)
    }
